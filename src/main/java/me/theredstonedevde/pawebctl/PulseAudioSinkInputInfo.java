        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.startsWith("Sink Input #")) {
                    ...
                    currentSinkInput.id = line.substring(12).trim();
                } else if (line.startsWith("application.name")) {
                    // Extract the sink input name
                    currentSinkInput.name = line.replaceAll("application.name = \"", "").replaceAll("\"", "");
