...
public class WebServer {
    private static final String HOST_ADDRESS = "192.168.0.243";
                                    ...
                                    .visible-xs {
                                        ...
                                        .glow-container::before {
                                            ...
                                            @media screen and (max-width: 800px) {
                                                ...
                                                .nav-right {
                                                    right: 2%;
                                                    top: 2%; /* Adjusted top position for responsiveness */
                                                }
                                            }
                                            ...
                                            @media screen and (max-width: 400px) {
                                                ...
                                                .nav-right {
                                                    right: 1%;
                                                    top: 1%; /* Adjusted top position for even smaller screens */
                                                }
                                            }
