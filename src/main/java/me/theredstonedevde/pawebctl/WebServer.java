                        ...
                        response+="""
                            ...
                            <head>
                               ...
                               @import url(https://fonts.googleapis.com/css?family=Arimo:400,400italic,700,700italic);
                                ...
                                const url='http://192.168.0.243:8193/mpris?id';
                                var lastsum = "none"
                                //Http.open("GET", url);
                             ...
                             <div class="nav-right visible-xs">
                               ...
                               <div class="glow-container">
                                ...
                                <div class="player-controls">
                                    ...
                                    <a href="http://192.168.0.243:8193" class="ua" target="_blank">
                                ...
                                <div class="sidebar">
                                    <ul class="sidebar-list">
                                        ...
                                        <li class="sidebar-item"><a href="http://192.168.0.243:8193" class="sidebar-anchor">Mixer </a></li>
                                        <li class="sidebar-item"><a href="#" class="sidebar-anchor">Settings</a></li>
                                    </ul>
                                </div>
